        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="flex items-end justify-between">
                ...
                <div class="flex justify-end pt-4">
                    <button type="submit"
                        class="flex justify-center px-2 py-2 text-white transition duration-300 ease-in-out bg-orange-500 border border-orange-600 rounded-md hover:bg-orange-600 focus:outline-none focus:border-orange-700 focus:shadow-outline active:bg-orange-700">
