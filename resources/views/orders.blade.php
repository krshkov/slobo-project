<x-layouts.guest>
    ...
    <div class="mt-20 w-full flex gap-20 flex-wrap justify-center">
    ...
    <section class="mt-20">
        <h2 class="text-center">Are you looking for the right craftsman?</h2>
        <p class="text-center">Let me know how to help you - publish a free advertisement now!</p>
        <div class="mt-10 flex justify-center">
            <div class="max-w-[600px] shadow p-3 rounded">
                <div class="flex items-start justify-between">
                    <div class="flex items-start gap-2">
                        <div class="w-fit rounded-full overflow-hidden max-w-[60px]">
                    ...
                    <div>
                        <span class="bg-green-300 text-green-800 p-2 rounded-xl text-xs">Now available</span>
                    </div>
                </div>

                <div class="mt-3 flex items-center gap-3">
                <span class="flex items-center bg-yellow-200 font-bold py-1 px-3 rounded">
                    <x-icon-star/> 4
                </span>
                    <small class="text-gray-500">38 review</small>
                </div>

                <div class="mt-5">
                    <span class="bg-blue-100 text-blue-500 px-3 py-1 rounded">Category</span>
                    <span class="bg-blue-100 text-blue-500 px-3 py-1 rounded">Category</span>
                    <span class="bg-blue-100 text-blue-500 px-3 py-1 rounded">Category</span>
                    <span class="bg-blue-100 text-blue-500 px-3 py-1 rounded">Category</span>
                </div>

                <p class="mt-5">10+ years of experience in the industry. Available for urgent missions. Active in the entire region around Rheda-Wiedenbrück .</p>

                <div class="mt-1 flex items-baseline justify-between">
                    <a href="#" class="text-primary font-bold">Show profile</a>
                    <button class="text-xs font-semibold cursor-pointer mt-10 flex justify-center px-6 py-3 text-white transition duration-300 ease-in-out bg-orange-500 border border-orange-600 rounded-xl hover:bg-orange-600 focus:outline-none focus:border-orange-700 focus:shadow-outline active:bg-orange-700">Contact</button>
                </div>
            </div>
        </div>
        <button
